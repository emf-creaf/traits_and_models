...
allom_db  <- readxl::read_xlsx("Sources/AllometrApp/shrub_fine_fuel_allometries_catalonia_2024-09-05.xlsx")
...
write.csv2(db_post, "Products/harmonized/shrub_fine_fuel_biomass_catalonia.csv", row.names = FALSE)
