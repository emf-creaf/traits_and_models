...
allom_db  <- readxl::read_xlsx("Sources/AllometrApp/tree_foliar_biomass_allometries_catalunya_2024-09-04.xlsx")
var_db <- allom_db |>
...
write.csv2(db_post, "Products/harmonized/tree_foliar_biomass_catalonia.csv", row.names = FALSE)
