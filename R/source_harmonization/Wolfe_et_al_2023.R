...
# Read database -----------------------------------------------------------
db <- readxl::read_excel(paste0(DB_path,"Sources/Wolfe_et_al_2023/pce14524-sup-0002-tables_s1_and_s2.xlsx"), sheet = "Table S2")
...
# Storing -----------------------------------------------------------------
saveRDS(db_post, "Products/harmonized/Wolfe_et_al_2023.rds")
