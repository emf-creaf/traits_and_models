...
# Read database -----------------------------------------------------------
fn <- file.path(DB_path, "Sources/Augustine_McCulloh_2024/Finaldata.csv")
db <- readr::read_csv("Sources/Augustine_McCulloh_2024/Finaldata.csv", na = "N/A")
...
# Storing -----------------------------------------------------------------
saveRDS(db_post, "Products/harmonized/Augustine_McCulloh_2024.rds")
