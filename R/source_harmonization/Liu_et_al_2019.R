...
# Read database -----------------------------------------------------------
db <- readxl::read_excel(paste0(DB_path,"Sources/Liu_et_al_2019/aav1332_table_s1.xlsx"), sheet = "full_data")
...
# Storing ----------------------------------
saveRDS(db_post, "Products/harmonized/Liu_et_al_2019.rds")
